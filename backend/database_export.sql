...
-- Exportacion completa para MySQL Workbench
-- Incluye: estructura + datos iniciales
-- con cifrado AES-256-GCM en campos sensibles
-- ============================================
...
-- Crear usuario con minimos privilegios (NO root)
CREATE USER IF NOT EXISTS 'cv_app'@'localhost' IDENTIFIED BY '<DB_PASSWORD>';
GRANT SELECT, INSERT, UPDATE, DELETE ON control_vehicular.* TO 'cv_app'@'localhost';
FLUSH PRIVILEGES;
...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  telefono VARCHAR(500) COMMENT 'Cifrado AES-256-GCM',
  rol_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS vehiculos (
  ...
  color VARCHAR(50),
  numero_motor VARBINARY(500) COMMENT 'Cifrado AES-256-GCM',
  numero_chasis VARBINARY(500) COMMENT 'Cifrado AES-256-GCM',
...
CREATE TABLE IF NOT EXISTS proveedores (
  ...
  telefono VARBINARY(500) COMMENT 'Cifrado AES-256-GCM',
  email VARBINARY(500) COMMENT 'Cifrado AES-256-GCM',
  direccion TEXT,
...
CREATE INDEX idx_vehiculos_tipo ON vehiculos(tipo_vehiculo_id);
CREATE INDEX idx_vehiculos_estado ON vehiculos(estado);
CREATE INDEX idx_solicitudes_vehiculo ON solicitudes_combustible(vehiculo_id);
CREATE INDEX idx_solicitudes_estado ON solicitudes_combustible(estado);
CREATE INDEX idx_solicitudes_fecha ON solicitudes_combustible(fecha_solicitud);
...
-- La clave de cifrado debe coincidir con ENCRYPTION_KEY en .env
-- Generar el hash SHA2-512 de la clave para AES_ENCRYPT/AES_DECRYPT
SET @encryption_key = 'a1f1f1b0884a3da02b1e07ab896fbb1e2f4d14821fd1483ba01d9c58acaa6567';

-- Usuarios (password hasheado con bcrypt, telefono cifrado)
-- Password: Admin@123
INSERT INTO usuarios (nombre, apellido, email, password, telefono, rol_id) VALUES
('Admin', 'Sistema', 'admin@controlvehicular.com', '$2b$10$UuAnuY0pNFxTTBc549LcZOoZnj1LjUt0/Fan2j3m/dQ23H5PsbD1i', AES_ENCRYPT('555-0100', UNHEX(SHA2(@encryption_key, 512))), 1);

-- Password: Empleado@123
INSERT INTO usuarios (nombre, apellido, email, password, telefono, rol_id) VALUES
('Empleado', 'Prueba', 'empleado@controlvehicular.com', '$2b$10$xpQ17bKflPI11ajp0ywtieg/5zuPl.bJ6Ni1KROMKMyRCceQEObS2', AES_ENCRYPT('555-0101', UNHEX(SHA2(@encryption_key, 512))), 2);
...
-- ============================================
-- NOTA: Para ver datos descifrados:
-- SELECT CAST(AES_DECRYPT(telefono, UNHEX(SHA2(@encryption_key, 512))) AS CHAR) FROM usuarios;
-- ============================================
